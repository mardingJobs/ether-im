...
//        put(ImMessageStatus.INTI, ImMessageEventType.SENT);
        ...
        put(ImChatMessageStatus.SENT, ImMessageEventType.PUSHED);
        put(ImChatMessageStatus.SENT, ImMessageEventType.WITH_DRAWN);
        put(ImChatMessageStatus.PUSHED, ImMessageEventType.REACHED);
        put(ImChatMessageStatus.PUSHED, ImMessageEventType.WITH_DRAWN);
