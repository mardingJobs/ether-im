...
import static cn.ether.im.common.constants.ImConstants.IM_GROUP_MESSAGE_TOPIC;
...
@RocketMQMessageListener(consumerGroup = IM_MESSAGE_PUSH_CONSUMER_GROUP,
        topic = IM_GROUP_MESSAGE_TOPIC, consumeMode = ConsumeMode.CONCURRENTLY)
public class ImGroupMessageMQListener
    ...
    public void onMessage(String message) {
        ...
        ImGroupMessage singleMessage = JSON.parseObject(message, ImGroupMessage.class);
        ThreadPoolUtils.execute(() -> {
            processorContext.process(null, new ImInfo<>(ImInfoType.GROUP, singleMessage));
        });
    }
    ...
    public void prepareStart(DefaultMQPushConsumer consumer) {
        try {
            ...
            consumer.subscribe(IM_GROUP_MESSAGE_TOPIC, tag);
